...
public class Grammar {
    ...
    /**
     * Uses the supplied BufferedReader to read and parse a file containing a BNF grammar. 
     * Each grammar rule must be on a single line, but may have multiple alternatives. The same nonterminal may
